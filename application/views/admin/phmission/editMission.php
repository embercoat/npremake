...
echo Form::hidden('mission_id', ((isset($mission_id))?$mission_id:'new'))
    ...
    .Form::select('starttime[minute]', array('00','15','30','45'), (isset($mission) ? date('i', $mission['startdate']) : ''), array('style="clear: right; width: 50px;"'))
    ...
    .Form::select('endtime[minute]', array('00','15','30','45'), (isset($mission) ? date('i', $mission['enddate']) : ''), array('style="clear: right; width: 50px;"'))
