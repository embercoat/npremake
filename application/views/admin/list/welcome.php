<a href="/admin/list/create">Skapa ny Lista</a>
<table>
<tr>
...
<tr>
    <td><a href="/admin/list/list/<?php echo $list['idlist']; ?>"><?php echo $list['name']; ?></a></td>
    <td><a href="/admin/list/participants/<?php echo $list['idlist']; ?>"><?php echo $list['count']; ?> Deltagare</a></td>
    ...
    <td><a href="/admin/list/deleteList/<?php echo $list['idlist']; ?>"><img src="/images/icon/red_x.svg" height="14px" /></a></td>
<?php }?>
</table>